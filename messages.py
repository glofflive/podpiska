...
START = f'🙋‍♂ Добро пожаловать в бот "SUB TREE". Я создан для того, чтобы помогать тебе получать взаимных подписчиков на твой канал. Перед началом использования бота, обязательно прочитай небольшую [инструкцию по использованию бота, а также правила]({LINK_TO_INTRODUCTION_AND_RULES})'
...
2) _Пришлите сюда юзернейм этого канала. Например:_ @KANAL'''
